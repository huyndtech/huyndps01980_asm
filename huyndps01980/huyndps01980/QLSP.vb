...
Public Class QLSP
    ...
    Dim conectrt As String = "workstation id=quanlybookstore.mssql.somee.com;packet size=4096;user id=huynd1;pwd=Nguyenhuy179;data source=quanlybookstore.mssql.somee.com;persist security info=False;initial catalog=quanlybookstore"
